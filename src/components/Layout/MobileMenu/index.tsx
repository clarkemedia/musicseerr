              ...
              {link.href === '/requests' &&
                ...
                hasPermission(Permission.MANAGE_REQUESTS) && (
                  <div className="ml-auto flex">
                    <Badge className="rounded-md border-green-500 bg-gradient-to-br from-green-600 to-green-600">
                      {pendingRequestsCount}
                    </Badge>
                  </div>
                )}
                        ...
                        <Badge
                          className={`bg-gradient-to-br ${
                            router.pathname.match(link.activeRegExp)
                              ? 'border-green-600 from-green-700 to-green-700'
                              : 'border-green-500 from-green-600 to-green-600'
                          } flex ${
