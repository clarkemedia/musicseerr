                ...
                >
                  <div
                    className={`provider-container relative w-full cursor-pointer rounded-lg ring-1 ${
                      isActive
                        ? 'bg-gray-600 ring-green-500 hover:bg-gray-500'
                  ...
                  >
                    ...
                    {isActive && (
                      <div className="pointer-events-none absolute -left-1 -top-1 flex items-center justify-center text-green-100 opacity-90">
