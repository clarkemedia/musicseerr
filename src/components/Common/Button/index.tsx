...
function Button<P extends ElementTypes = 'button'>(
  ...
  switch (buttonType) {
    case 'primary':
      buttonStyle.push(
        'text-white border border-green-500 bg-green-600/80 hover:bg-green-600 hover:border-green-500 focus:border-green-700 focus:ring-green active:bg-green-600 active:border-green-700'
      );
      break;
    case 'danger':
      buttonStyle.push(
