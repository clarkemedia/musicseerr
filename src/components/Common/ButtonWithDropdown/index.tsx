...
const ButtonWithDropdown = ({
  ...
  switch (buttonType) {
    ...
    default:
      styleClasses.mainButtonClasses +=
        ' bg-green-600/80 border-green-500 hover:bg-green-600 hover:border-green-500 active:bg-green-700 active:border-green-700 focus:ring-blue';
      styleClasses.dropdownSideButtonClasses +=
        ' bg-green-600/80 border-green-500 hover:bg-green-600 active:bg-green-600 focus:ring-blue';
  }
