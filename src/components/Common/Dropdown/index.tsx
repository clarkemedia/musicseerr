    ...
    <Menu.Item>
      <a
        className={[
          ...
          buttonType === 'ghost'
            ? 'bg-transparent from-green-600 to-green-600 hover:bg-gradient-to-br focus:border-gray-500'
            : 'bg-green-600 hover:bg-green-500 focus:border-green-700',
        ].join(' ')}
        {...props}
      >
        {children}
      ...
      <Menu.Button
        ...
        className={[
          ...
          buttonType === 'ghost'
            ...
            : `focus:ring-blue border-green-500 bg-green-600/80 hover:border-green-500 hover:bg-green-600 active:border-green-700 active:bg-green-700`,
          className,
        ].join(' ')}
        ref={buttonRef}
        disabled={!children}
